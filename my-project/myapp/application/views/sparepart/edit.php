                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="namaSparepart" value="<?= $sparepart['nama_sparepart'] ?>">
								...
								<div class="form-group">
									...
									<select name="category" id="" class="form-control">
										...
										<?php foreach ($category as $category):?>
											<?php if ($sparepart['category_id'] == $category['id']){?>
							...
							<div class="col-md-6">
								<div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="harga" value="<?= $sparepart['harga'] ?>">
