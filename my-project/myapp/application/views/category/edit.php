                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="namaCategory" value="<?= $category['nama_kategori'] ?>">
                                    <small id="emailHelp" class="form-text text-danger"><?= form_error('namaCategory'); ?></small>
                                </div>
                            </div>
                            <div class="col-md-6">
